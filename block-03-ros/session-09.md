...
**Goal:** Students execute the complete TurtleBot3 autonomous navigation workflow step by step in the Gazebo simulation and document what they observe. They can explain the role of SLAM, localisation, and path planning in a running system — connecting theory from Session 8 to observable behaviour.
...
Brief review of Session 8 concepts students need for today:
