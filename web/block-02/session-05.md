...
Extend your existing robot model with additional ground sensors directly in Webots, and verify the sensor readings in the simulation console. This session is a technical bridge — it prepares you for the line-following assignment in Session 6.
