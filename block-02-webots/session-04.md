...
Independent work phase (approx. 2 sessions) followed by group presentations.

---

## Deliverable

Presentation of maze-solving approach; working simulation demo. *(Graded — part of the 70% in-semester component)*
...
|---|---|---|
| `assignments/labyrinth.md` | Assignment sheet handed out to students | ⏳ To do (AP3) |
| `templates/labyrinth_template.py` | Controller template with `TODO` gaps | ⏳ To do (AP3) |
| `worlds/labyrinth.wbt` | Pre-built Webots world | ⏳ To do (AP3) |
