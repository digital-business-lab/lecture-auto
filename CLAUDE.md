...
- VM specs not yet confirmed — verify Webots and Plant Simulation run before semester starts (→ `docs/semester-prep.md`).
- Plant Simulation licence installation on VMs still to be verified.
