...
| # | Topic | Method | Material |
|---|---|---|---|
| 1 | **Industry-specific aspects and examples** — AGV applications across sectors based on case studies from the course textbook | Group work + plenary discussion | Textbook (Ullrich & Albrecht, Ch. on application examples); assignment sheet |
...
**Topic 1 — Industry-specific aspects (case studies from the textbook):**

Each group analyses their assigned case studies from Ullrich & Albrecht and answers the following four questions:

1. **Task** — What transport task needs to be fulfilled in this application?
2. **Requirements** — What specific requirements result from the task and/or the industry context (load types, environment, hygiene, safety, cycle times, etc.)?
...
Output: brief plenary report-back (2–3 min per group), structured around these four questions.

**Group assignments:**

| Group | Case studies (from textbook) |
|---|---|
...
**Lecturer note:** Groups 1 and 2 both cover automotive cases — draw out the differences in the debrief (assembly line vs. intralogistics, vehicle type differences, scale). The four-question structure maps directly onto the requirements analysis students will conduct in the business case.
...
### Preparation Checklist
- [ ] Assignment sheet for industry group work: four questions + group/case-study assignment table (Groups 1–7)
